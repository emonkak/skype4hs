...
getTimestamp :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m Timestamp
...
getSender :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m UserID
...
getSenderDisplayName :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m UserDisplayName
...
getType :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m ChatMessageType
...
getStatus :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m ChatMessageStatus
...
getLeaveReason :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m ChatMessageLeaveReason
...
getChat :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m ChatID
...
getAllUsers :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m [UserID]
...
isEditable :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m Bool
...
getBody :: (MonadIO m, MonadSkype m) => ChatMessageID -> SkypeT m ChatMessageBody
...
setBody :: (MonadIO m, MonadSkype m) => ChatMessageID -> ChatMessageBody -> SkypeT m ChatMessageBody
